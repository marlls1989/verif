...
check_sec -setup -spec_top mac4 \
            -imp_top mac4 \
            -imp_analyze "-sv rtl/mac4_gatting.sv" \
            -spec_analyze  "-sv rtl/mac4.sv" \
...
#check_sec -set_context -id 0 -spec_delay 0 -imp_delay 1
